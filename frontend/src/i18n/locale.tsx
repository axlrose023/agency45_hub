...
const translations: Record<Locale, Record<string, string>> = {
  ua: {
    ...
    accountUnsettled: 'Не оплачено',
    accountDisabled: 'Вимкнено',
    ...
    datePresetYesterday: 'Вчора',
    datePresetThisWeek: 'Цей тиждень',
    ...
    confirm: 'Підтвердити',
    cancel: 'Скасувати',
    insightSpend: 'Витрати',
    insightImpressions: 'Покази',
    insightClicks: 'Кліки',
    insightCPC: 'Ціна/клік',
    insightCPM: 'CPM',
    insightCTR: 'CTR',
    insightReach: 'Охоплення',
    insightConversations: 'Запити на переписку',
    broadcastTitle: 'Розсилки',
    broadcastDescription: 'Отримайте звіт по рекламних кабінетах у Telegram',
    broadcastToday: 'Сьогодні',
    broadcastYesterday: 'Вчора',
    broadcastWeek: 'За тиждень',
    broadcastMonth: 'За місяць',
    broadcastLast30: '30 днів',
    broadcastSending: 'Надсилання...',
    broadcastSent: 'Звіт надіслано у Telegram!',
    broadcastError: 'Не вдалося надіслати звіт. Перевірте підключення Facebook.',
    broadcastDailyNote: 'Щоденний звіт надходить автоматично о 9:00',
    dailyReportsLabel: 'Щоденні звіти о 9:00',
    dailyReportsDescription: 'Отримувати звіт за вчора кожного ранку',
  },
  ru: {
    ...
    datePresetYesterday: 'Вчера',
    datePresetThisWeek: 'Эта неделя',
    ...
    confirm: 'Подтвердить',
    cancel: 'Отмена',
    insightSpend: 'Расходы',
    insightImpressions: 'Показы',
    insightClicks: 'Клики',
    insightCPC: 'Цена/клик',
    insightCPM: 'CPM',
    insightCTR: 'CTR',
    insightReach: 'Охват',
    insightConversations: 'Запросы на переписку',
    broadcastTitle: 'Рассылки',
    broadcastDescription: 'Получите отчёт по рекламным кабинетам в Telegram',
    broadcastToday: 'Сегодня',
    broadcastYesterday: 'Вчера',
    broadcastWeek: 'За неделю',
    broadcastMonth: 'За месяц',
    broadcastLast30: '30 дней',
    broadcastSending: 'Отправка...',
    broadcastSent: 'Отчёт отправлен в Telegram!',
    broadcastError: 'Не удалось отправить отчёт. Проверьте подключение Facebook.',
    broadcastDailyNote: 'Ежедневный отчёт приходит автоматически в 9:00',
    dailyReportsLabel: 'Ежедневные отчёты в 9:00',
    dailyReportsDescription: 'Получать отчёт за вчера каждое утро',
  },
};
